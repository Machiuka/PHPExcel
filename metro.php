...
try {
  ...
  //  $BaseMem = memory_get_usage();
    ...
    foreach ($Sheets as $Index => $Name) {
        ...
        //		$Time = microtime(true);
    $mesaj = $mesaj . "<tr align='center'><th>Nr.crt.</th><th>Denumire</th><th>Pozitie</th><th>Data Scadentei</th></tr>";
        ...
        foreach ($Spreadsheet as $Key => $Row) {
            ...
            if ($Row) {
                ...
                if ($diff <= 5 && $diff > 0) {
                    ...
                    $mesaj = $mesaj . "<td align='right'>" . $i . ")</td><td>" . $denumire . "</td><td align='right'> " . $pozitie . "</td><td align='center'>" . $scadenta . "</td>";
                    $mesaj = $mesaj . "</tr>";
...
$subject = "Scadentele de azi la SDV-uri " . $azi;
$body = $mesaj;
